...
setup(
    ...
    ext_modules=[Extension('jsbsim', ['C:/Users/intern-laptop/Desktop/JSBSim/build/python/jsbsim.cxx'],
                           libraries=['JSBSim'],
                           include_dirs=[os.path.join('C:/Users/intern-laptop/Desktop/JSBSim',
                                                      'src'),
                                         os.path.join('C:/Users/intern-laptop/Desktop/JSBSim',
                                                      'python')],
                           library_dirs=[os.path.join('C:/Users/intern-laptop/Desktop/JSBSim/build',
                                                      'src')],
                           language='c++')])
...
setup(
    ...
    ext_modules=[Extension('fpectl',
                           sources=[os.path.join('C:/Users/intern-laptop/Desktop/JSBSim',
                                                 'python',
                                                 'fpectlmodule.cpp')],
                           language='c++')])
